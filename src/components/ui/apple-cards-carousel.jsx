...
export  const Carousel = ({ items, initialScroll = 0 }) => { //export thaich func
  ...
  const handleCardClose = (index) => {
    if (carouselRef.current) {
      const cardWidth = isMobile() ? 160 : 280; // Adjusted card width
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            <motion.div
              ...
              className="w-full h-full bg-white dark:bg-neutral-900 z-[60] p-4 md:p-10 font-sans relative overflow-y-auto"
            >
              <button
